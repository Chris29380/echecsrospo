<?php
    ...
    if($urlreq == "/" || $urlreq == "/index.php" || $findCible === false) {
        echo '
            ...
            <div class="menuacc">
                <ul>
                    ...
                    <li><a href="/index.php?cours"><i class="fa-solid fa-folder"></i> Les Cours</a></li>
                    <li><a href="/index.php?rapide3etangs"><i class="fa-solid fa-folder"></i> Rapide des 3 Etangs</a></li>
                    <li><a href="/index.php?actualites"><i class="fa-solid fa-folder"></i> Actualités</a></li>
                    <li><a href="/index.php?contact"><i class="fa-solid fa-folder"></i> Nous Contacter</a></li>
                </ul>
            </div>
